            ...
            <div className="row align-items-center">
              <div className="col-xl-3 col-lg-6 col-md-6 col-6">
                <div className="tp-header-logo tp-header-3-logo">
                  <Link className="logo-1" href="/home-4">
                    <Image 
                    src={logo_1}
                    alt="logo" 
                    />
              ...
              <div className="col-xl-3 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3-right d-flex align-items-center justify-content-end">
                  <div className="tp-header-3-social d-none d-sm-block">
                    <a href="https://www.youtube.com/@sudotechserve">
                      <i className="fa-brands fa-youtube"></i>
                    </a>
                    <a href="https://www.facebook.com/sudotechserve">
                      <i className="fa-brands fa-facebook"></i>
                    </a>
                    <a href="https://www.instagram.com/sudotechserve">
